    ...
    <div class="row">
        ...
        function drawChart() {
            ...
            <?php 
                ...
                $elements_count = [$post_counts,$post_published_counts,$post_draft_counts,$count_comments,$comment_unapproved_counts,$count_users,$user_subscribers_counts,$count_categories];
